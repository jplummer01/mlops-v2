...
git_folder_location=~/mlopsv2-demo/mlops-v2-projects  #replace with the local root folder location where you want to create the project folder
project_name=mlops-v2-adoproject  #replace with your project name
github_org_name=jplummer01   #replace with your github org name
